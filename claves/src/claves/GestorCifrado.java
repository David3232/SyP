...
public class GestorCifrado {
	...
	public void recibirClavePublicaOtro(InputStream stream) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        clavePublicaOtro = kf.generatePublic(ks);
	}
	...
	public void enviarMensajeCifrado(byte[] paraCifrar, OutputStream stream) throws IOException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {		
        byte[] mensajeCifrado = cifrar(paraCifrar, clavePublicaOtro);
        ByteBuffer bb = ByteBuffer.allocate(4);
	...
	public String recibirMensajeCifrado(InputStream stream) throws IOException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
