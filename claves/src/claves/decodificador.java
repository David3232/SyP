...
public class decodificador {
	...
	public static void main (String[] args) throws IOException {
		...
		desplazamiento = desplazamiento % 26;
           ...
           System.out.println("Código descifrado  -->  " + cifrado.toString());
	}
	
	// Función para obtener el caracter más repetido, que significará que es el espacio,
	// pues en una frase tan larga, es el caracter que mas se va a repetir
